...
export function AppHeader({ className = "" }: AppHeaderProps) {
  ...
  return (
    <div
      className={`${!isHomepage ? "border-border dark:border-input border-b" : ""} ${className}`}
    >
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden items-center gap-4 lg:flex">
            ...
            <Button
              className="h-fit bg-zinc-900 px-2 py-1.5 text-sm text-zinc-50 hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
              asChild
            >
